...
class GeneralBattleAssets: 
	...
	# 准备 
	I_PREPARE_HIGHLIGHT = RuleImage(roi_front=(1128,536,100,100), roi_back=(1110,500,169,200), threshold=0.7, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_prepare_highlight.png")
	# 战斗胜利 
